...
-(void) shouLargeDishView{
    ...
    [self.menuLargeImageScrollView setContentOffset:CGPointMake(0.0, 0.0)];
    self.menuLargeImageScrollView.delaysContentTouches = YES;
    self.menuLargeImageScrollView.canCancelContentTouches = YES;

    [self loadLargeImageScrollViewWithPage:0];
    [self loadLargeImageScrollViewWithPage:1];
}
...
//    [imageView addSubview:self.menuLargeImageScrollView];
//    [self.view addSubview:imageView];
    ...
    if ([mydishInfo.stock intValue]==0){
        UIImageView *soldOutImg=[[UIImageView alloc]initWithFrame:CGRectMake(600, 250, 340, 340)];
    ...
    //[darkView addGestureRecognizer:tapGestureDark];
...
- (void)plusDish:(UIButton *)button {
    ...
    UIView *darkView;
    DishInfo *mydishInfo =[DishInfo selectByDishID:self.BigImageDishId];
    ShopCar *shopCar=[[ShopCar alloc]init];
    if (partflag==1){
        shopCar=[ShopCar selectWithPrice:mydishInfo.dishID withPrice:mydishInfo.smallDishPrice];
...
-(void) dishPart1:(UIButton*)sender{
    ...
    int dishPartFramex=40;
    int dishPartFramey=20;
    UIColor *dishPartfontColor=[UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1];DishInfo *mydishInfo =[DishInfo selectByDishID:self.BigImageDishId];
